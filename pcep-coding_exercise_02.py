# Coding Exercise 2: Variables and Operators
#
# Scenario:
...
print('Your income is ' + str(income) + ' and you would pay ' + str(income * lowtaxland_rate) + ' income tax in Lowtaxland or ' + str(income * ripoffland_rate) + ' income tax in Ripoffland. You would save ' + str((income * ripoffland_rate) - (income * lowtaxland_rate)) + ' by paying taxes in Lowtaxland!')
